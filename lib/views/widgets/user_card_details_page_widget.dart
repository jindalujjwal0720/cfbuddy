import 'package:bloc1/business_logic/cubit/user_card_details_page_cubit.dart';
...
class UserCardDetailsPageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UserCardDetailsPageCubit, UserCardDetailsPageState>(
      builder: (context, state) {
        if (state is UserCardDetailsPageLoaded) {
          return Padding(
