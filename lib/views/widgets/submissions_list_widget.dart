...
class SubmissionsListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SubmissionsListCubit, SubmissionsListState>(
      builder: (context, state) {
        if (state is SubmissionsListLoaded) {
          ...
          for (var element in state.submissions) {
            _rows.add(
              DataRow(cells: [
                ...
                DataCell(Center(child: Text("${element.timeConsumedMillis}"))),
                DataCell(Center(
          ...
          return Padding(
            ...
            child: const ErrorStates().basicErrorWidget(() {}),
          );
        } else {
